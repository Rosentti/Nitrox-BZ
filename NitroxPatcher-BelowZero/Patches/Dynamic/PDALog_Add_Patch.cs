...
public sealed partial class PDALog_Add_Patch : NitroxPatch, IDynamicPatch
{
    ...
    public static void Postfix(string key, bool playSound, PDALog.EntryData __result)
    {
        ...
        Resolve<IPacketSender>().Send(new PDALogEntryAdd(key, entry.timestamp, playSound));
    }
}
