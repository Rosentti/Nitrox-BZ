...
global using static NitroxClient_BelowZero.Helpers.NitroxEntityExtensions;
using System;
using System.IO;
...
using NitroxModel_BelowZero.Logger;
using UnityEngine;

namespace NitroxPatcher_BelowZero;
...
public static class Main
{
    ...
    {
        Log.Setup(gameLogger: new BelowZeroInGameLogger(), useConsoleLogging: false);
