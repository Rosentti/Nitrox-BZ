...
namespace NitroxModel.Platforms.Store
{
    public sealed class Steam : IGamePlatform
    {
        ...
        {
            return File.Exists(Path.Combine(gameDirectory, "Subnautica_Data", "Plugins", "x86_64", "steam_api64.dll")) || File.Exists(Path.Combine(gameDirectory, "SubnauticaZero_Data", "Plugins", "x86_64", "steam_api64.dll"));
        }
