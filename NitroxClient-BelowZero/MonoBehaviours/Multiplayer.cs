...
namespace NitroxClient_BelowZero.MonoBehaviours
{
    public class Multiplayer : MonoBehaviour
    {
        ...
        {
            Log.Info("Nitrox wait world settling");
            ...
            Log.Info("Nitrox wait join session");
        ...
        {
            Log.Info("Nitrox set loading completed");
            WaitScreen.main.isShown = false;
        ...
        {
            Log.Info("Init local player state");
