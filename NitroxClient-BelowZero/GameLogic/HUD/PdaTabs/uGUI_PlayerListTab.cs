...
using NitroxClient_BelowZero.GameLogic.HUD.Components;
using NitroxClient_BelowZero.GameLogic.PlayerLogic.PlayerModel.Abstract;
using NitroxModel.Core;
using TMPro;
using UnityEngine;
using UnityEngine.UI;
using static NitroxClient_BelowZero.Unity.Helper.AssetBundleLoader;

namespace NitroxClient_BelowZero.GameLogic.HUD.PdaTabs;
