...
public class Vehicles
{
    ...
    public void BroadcastVehicleDocking(VehicleDockingBay dockingBay, Dockable vehicle)
    {
    ...
    public void BroadcastVehicleUndocking(VehicleDockingBay dockingBay, Dockable vehicle, bool undockingStart)
    {
