...
using NitroxClient_Subnautica.GameLogic.HUD.Components;
using NitroxClient_Subnautica.GameLogic.PlayerLogic.PlayerModel.Abstract;
using NitroxModel.Core;
using TMPro;
using UnityEngine;
using UnityEngine.UI;
using static NitroxClient_Subnautica.Unity.Helper.AssetBundleLoader;

namespace NitroxClient_Subnautica.GameLogic.HUD.PdaTabs;
